...
- `deadline Submit report /by 25 Feb 2025 5pm` : Add a deadline.
- `bye` : Exit the app.
...
- Add `HHmm` for time (e.g., `2025-02-25 1700` or `25/2/2025 5pm`)

**Examples:**
- `deadline Submit assignment /by 28 Feb 2025 2359`
...
**Example:** `event Team meeting /from 25 Feb 2025 2pm /to 25 Feb 2025 4pm`
...
Shows deadlines and events on a specific date.

**Format:** `on DATE`

**Example:** `on 25 Feb 2025`

**Expected outcome:** A list of tasks that fall on that date (deadlines by that date, events on that date).
...
| Add deadline      | `deadline DESC /by DATE [TIME]`             | `deadline Submit report /by 28 Feb`   |
| Add event         | `event DESC /from START /to END`             | `event Meeting /from 25 Feb 2pm /to 4pm` |
| List tasks        | `list`                                      | `list`                                |
| Find tasks        | `find KEYWORD`                              | `find meeting`                        |
| Tasks on date     | `on DATE`                                   | `on 25 Feb 2025`                      |
